...
public class InsertJobPostActivity extends AppCompatActivity {
    ...
    toolbar = (Toolbar)findViewById(R.id.insert_job_toolbar);
      ...
      mAuth=FirebaseAuth.getInstance();
        ...
        mJobPost= FirebaseDatabase.getInstance().getReference().child("Job App")
                .child(uId);

        mPublicDatabase=FirebaseDatabase.getInstance().getReference()
 ...
 private void InsertJob(){
        ...
        job_skills=findViewById(R.id.skills);
        job_salary = findViewById(R.id.sallary) ;
        ...
        btn_post_job.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Data data= new Data(id,title,description,skills,salary,date);
