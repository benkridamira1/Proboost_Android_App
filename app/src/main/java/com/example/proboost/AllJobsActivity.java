...
public class AllJobsActivity extends AppCompatActivity {
  ...
  /*
    ...
    private DatabaseReference mAllJobPostdatabase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar=(Toolbar)findViewById(R.id.all_job_post);
        setSupportActionBar(toolbar);
        ...
        //Databsase
        mAllJobPostdatabase= FirebaseDatabase.getInstance().getReference()
                .child("Public database");

        mAllJobPostdatabase.keepSynced(true);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Data> firebaseRecyclerOptions =
                new FirebaseRecyclerOptions.Builder<Data>()
                        .setQuery(mAllJobPostdatabase, Data.class)
                        .build();
